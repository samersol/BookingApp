export default function Perks ({selected,onChange}){
    ...
    return(
        <>
                    <label className="border  p-5 items-center flex  gap-1 m-2 rounded-2xl cursor-pointer">
                    <input type="checkbox" checked={selected.includes('wifi')} name="wifi" onChange={handlePerks}/>
                    <span className="px-2 flex gap-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-7 h-7">
                    ...
                    <label className="border p-5 items-center flex  gap-1 m-2 rounded-2xl cursor-pointer">
                    <input type="checkbox" checked={selected.includes('entrance')} name="entrance" onChange={handlePerks}/>
                    <span className="px-2  flex gap-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-7 h-7">
